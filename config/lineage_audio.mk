...
ALARM_PATH := vendor/neox/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/neox/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/neox/prebuilt/common/media/audio/ringtones
...
PRODUCT_COPY_FILES += \
    ...
    $(RINGTONE_PATH)/Moto.ogg: system/media/audio/ringtones/Moto.ogg
endif
